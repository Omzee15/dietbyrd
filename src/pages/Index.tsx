    ...
    <div className="flex-1 flex flex-col pt-4 xl:pt-8 pb-3 pl-10 xl:pl-14 pr-4 overflow-y-auto no-scrollbar">
      <div className="relative z-10 w-full max-w-[480px] xl:max-w-[540px] mt-auto mb-auto py-1">
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-stretch max-w-[400px] xl:max-w-[440px] relative z-20">
          {/* Dietitian Column */}
          <div className="flex-[1.2] bg-transparent border border-[#33654A]/20 sm:border-r-transparent rounded-[14px] p-3.5 xl:p-4 shadow-sm">
          ...
          {/* Doctors Column */}
          <div className="flex-1 bg-transparent border border-[#33654A]/20 sm:border-r-transparent rounded-[14px] p-3.5 xl:p-4 shadow-sm relative overflow-hidden">
