    ...
    <div className="flex-1 flex flex-col justify-center pl-12 xl:pl-16 pr-4 py-6">
      <div className="relative z-10 w-full max-w-[600px] xl:max-w-[700px]">
        ...
        <div className="flex flex-col sm:flex-row gap-4 xl:gap-5 items-stretch max-w-[580px] xl:max-w-[620px] relative z-20">
          ...
          {/* Doctors Column */}
          <div className="flex-1 bg-white border border-[#33654A]/20 rounded-[16px] p-5 shadow-sm relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-[12px] text-[#0A1628] font-medium leading-relaxed mt-6 relative z-10">
          ...
          <div className={`absolute inset-0 pointer-events-none ${showJoinForm ? 'z-30' : 'z-[5]'}`}>
            {showJoinForm ? (
              <img 
                ...
                className="absolute bottom-[0%] right-[0%] h-[92%] xl:h-[100%] object-contain object-bottom translate-x-[15%] xl:translate-x-[18%]"
