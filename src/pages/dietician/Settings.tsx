          ...
          <div className="bg-card rounded-xl border p-6">
            ...
            <div className="grid gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="e.g., Diabetes, Weight Management" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl border p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-sm">New Patient Assignments</div>
                  <div className="text-xs text-muted-foreground">Get notified when new patients are assigned</div>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-medium text-sm">Consultation Reminders</div>
                  <div className="text-xs text-muted-foreground">Reminders before scheduled consultations</div>
                </div>
                <Switch defaultChecked />
              </div>
              <div className="flex items-center justify-between">
