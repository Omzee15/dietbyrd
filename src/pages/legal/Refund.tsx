...
const Refund = () => (
  <LegalLayout title="Refund Policy" lastUpdated="May 2026">
    <div className="legal-page">
      ...
      <p>We will always review such requests with empathy and without bureaucratic rigidity. Write to us at <a href="mailto:support@dietbyrd.com">support@dietbyrd.com</a> with a brief explanation. We will respond within 24 hours.</p>
      ...
      <p>If you have concerns about the advice you received, please contact us at <a href="mailto:support@dietbyrd.com">support@dietbyrd.com</a>. We will review the matter with your RD and follow up with you directly.</p>
      ...
      <p>Email us at <a href="mailto:support@dietbyrd.com">support@dietbyrd.com</a> with the subject line "Refund Request" and include:</p>
      <ul>
